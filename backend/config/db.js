...
const connectDB = async () => {
  try {
    // 打印连接信息（隐藏密码）
    console.log('数据库连接信息:');
    console.log('主机:', '37.114.34.146');
    console.log('用户名:', 'japaneseTrain_sdhaif25211gaAGH');
    console.log('数据库名:', 'japanesetrain_sdhaif25211gaagh');
    console.log('端口:', 3306);
    ...
    const testPool = mysql.createPool({
      host: '37.114.34.146',
      port: 3306,
      user: 'japaneseTrain_sdhaif25211gaAGH',
      password: 'ajxprdfsAfWF6aPb',
    ...
    pool = mysql.createPool({
      ...
      user: 'japaneseTrain_sdhaif25211gaAGH',
      password: 'ajxprdfsAfWF6aPb',
      database: 'japanesetrain_sdhaif25211gaagh',
      waitForConnections: true,
      connectionLimit: 10,
      queueLimit: 0,
      connectTimeout: 10000,
